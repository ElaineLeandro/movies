import { Container, Content, ContentTitle,Icon,Tags, ContentDateTime, Description} from "./styles";
...
export function MoviePreview({Icon: icon}){
    return(
        <>
            ...
            <p>Um dos aspectos mais interessantes do filme é que ele conta a mesma narrativa a partir de vários pontos de vista. 
            ...
            se "enturmar" quando fez piadas sobre o garoto novo.</p>
            <p>Na escola, a turma está estudando preceitos e reflete sobre a antiga citação egípcia: “seus feitos são seus monumentos”.
            ...
            falando mal dele com o resto da classe e fica sozinho de novo.</p> 
            </Description>
